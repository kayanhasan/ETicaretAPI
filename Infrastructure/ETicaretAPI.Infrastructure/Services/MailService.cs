...
namespace ETicaretAPI.Infrastructure.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendMailAsync(string[] tos, string subject, string body, bool isBodyHtml = true)
        {
            ...
            mail.Body = body;
            mail.From = new(_configuration["Mail:Username"], "HK-ETicaret", System.Text.Encoding.UTF8);
        ...
        public async Task SendPasswordResetMailAsync(string to, string userId, string resetToken)
        {
            ...
            mail.AppendLine("\">Yeni şifre talebi için tıklayınız...</a></strong><br><br><span style=\"font-size:12px;\">NOT : Eğer ki bu talep tarafınızca gerçekleştirilmemişse lütfen bu maili ciddiye almayınız.</span><br>Saygılarımızla...<br><br><br>HK - Mini|E-Ticaret");
